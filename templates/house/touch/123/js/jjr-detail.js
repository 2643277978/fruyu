        ...
        if(data && data.state == 100){
          ...
          if(type == 'sale'){
            for(var i = 0; i < list.length; i++){
              ...
              var price = '';
              if(d.price > 0){
                price = '<span class="price r">'+d.price+'万元</span>';
              }else{
            ...
            for(var i = 0; i < list.length; i++){
              ...
              var junjia = '';
              if(d.price > 0){
                price = '<span class="price r">'+d.price+'元/月</span>';
                junjia = '<em class="r">均价 '+Math.ceil(d.price / d.area)+'元/平</em>';
              }else{
                price = '<span class="price r">面议</span>';
              }
              ...
              if(d.price > 0){
                ...
                if(d.type == 1){
                  ...
                  if(d.type == 2){
                    ...
                    transfer = (d.price / d.area).toFixed(0) + '元/m²•月';
                  }
                }
              }else{
            ...
            for(var i = 0; i < list.length; i++){
              ...
              if(d.type == 0){
                if(d.price > 0){
                  price = '<strong>'+d.price+'</strong><span>元/月</span>';
                  transfer = (d.price / d.area).toFixed(0) + '元/m²•月';
                }
              }else if(d.type == 1){
                if(d.price > 0){
