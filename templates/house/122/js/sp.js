$(function () {
    ...
    function checkFilter(){
      ...
      $('.filterlist dl').each(function(g){
        ...
        // 价格
            ...
            if( (pagetype == 'sp_zu' && g == 3) || (pagetype == 'sp_sale' && g == 2) || pagetype == 'sp_zr' ){
                return;
            }
    ...
    $('.inp_price').delegate('.btn', 'click', function(event) {
        ...
        zdprice = zdpriceLow + '-' + zdpriceTop +'元';
    ...
    function getList() {
        ...
        var url = masterDomain + "/include/ajax.php?service=house&action=spList";
                ...
                if (data.state==100) {
                    ...
                    for (var i = 0; i < list.length; i++) {
                        ...
                        if (d.type == 0 || d.type == 2) {
                            html.push('<span class="lpprice">' + (d.price > 0 ? '<b>' + d.price + '</b>元/月' :
                                '<b>价格面议</b>') + '</span>');
                        } else {
                            html.push('<span class="lpprice">' + (d.price > 0 ? '<b>' + d.price + '</b>万' :
                                '<b>价格面议</b>') + '</span>');
                        }
                        html.push('</div>');
                        ...
                        html.push('</div>');
                        if (d.type == 0) {
                            html.push('<div class="sp_r fn-right">' + (d.price / d.area).toFixed(1) + ' 元/平米·月</div>');
                        } else if (d.type == 1) {
                            html.push('<div class="sp_r fn-right">' + (d.price / d.area).toFixed(1) + ' 万/平米</div>');
                        }else {
