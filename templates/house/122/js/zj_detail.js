$(function(){
	...
	function getList(tr){
        ...
        if(action=="team"){//团队
            ...
            pageSize = 8;//8
            url =  masterDomain + "/include/ajax.php?service=house&action=zjUserList&page=" + atpage + "&pageSize=" + pageSize + "&comid=" + storeId;
            ...
            pageSize = 8;//8
            url =  masterDomain + "/include/ajax.php?service=house&action=saleList&check_collect=1&page=" + atpage + "&pageSize=" + pageSize + "&comid=" + storeId;
            ...
            pageSize = 8;//8
            url =  masterDomain + "/include/ajax.php?service=house&action=zuList&check_collect=1&page=" + atpage + "&pageSize=" + pageSize + "&comid=" + storeId;
            ...
            pageSize = 8;//8
            url =  masterDomain + "/include/ajax.php?service=house&action=xzlList&page=" + atpage + "&pageSize=" + pageSize + "&comid=" + storeId;
            ...
            pageSize = 8;//8
            url =  masterDomain + "/include/ajax.php?service=house&action=spList&check_collect=1&page=" + atpage + "&pageSize=" + pageSize + "&comid=" + storeId;
            ...
            pageSize = 8;//8
            url =  masterDomain + "/include/ajax.php?service=house&action=cfList&check_collect=1&page=" + atpage + "&pageSize=" + pageSize + "&comid=" + storeId;
            ...
            pageSize = 8;//8
            url =  masterDomain + "/include/ajax.php?service=house&action=cwList&check_collect=1&page=" + atpage + "&pageSize=" + pageSize + "&comid=" + storeId;
        }
        $.ajax({
            url: url,
            type: "GET",
                ...
                if (data && data.state == 100) {
                    ...
                    if(action=="team"){
                        ...
                        for (var i = 0, lr; i < list.length; i++) {
                            ...
                            html.push('<div class="lpinf fn-clear"><div class="sp_l fn-left"><span>'+lr.room+'</span><em>|</em><span>'+parseInt(lr.area).toFixed(1)+'m²</span><em>|</em><span>'+lr.buildage+'年</span><em>|</em><span>'+lr.direction+'</span><em>|</em><span>'+lr.zhuangxiu+'</span><em>|</em><span>'+lr.bno+'/'+lr.floor+'层</span><em>|</em><span>'+elevatortxt+'</span></div><div class="sp_r fn-right">'+parseInt(lr.unitprice).toFixed(0)+' 元/m²</div></div>');

                            html.push('<p class="lpinf">['+lr.addr[3]+']  '+lr.address+'</p>');
                        ...
                        for (var i = 0, lr; i < list.length; i++) {
                            ...
                            html.push('<a href="'+lr.url+'"><h2>'+lr.title+'</h2></a>');
                            if(lr.price>0){
                                html.push('<span class="lpprice"><b>'+parseInt(lr.price).toFixed(0)+'</b>元/月</span>');
                            }else{
                                html.push('<span class="lpprice"><b>面议</b></span>');
                            }
                            html.push('</div>');
                        ...
                        for (var i = 0, lr; i < list.length; i++) {
                            ...
                            if(lr.price>0){
                                if(lr.type == 1){
                                    ...
                                    html.push('<span class="lpprice"><b>'+parseInt(lr.price).toFixed(0)+'</b>元/m²•月</span>');
                                }
                            }else{
                                html.push('<span class="lpprice"><b>面议</b></span>');
                            }
                            ...
                            if(lr.price>0){
								if(lr.type==1){
									elevatortxt = (lr.price / lr.area * 10000).toFixed(0) + '元/m²';
                            	}else{
                            		elevatortxt = (lr.price * lr.area ).toFixed(0) + '元/m²•月';
                            	}
                            }
									...
									html.push('<div class="infobox fn-left">');
			                            ...
			                            if(lr.type==1){
											if(lr.price>0){
			                           		...
			                           		if(lr.price>0){
			                           			elevatortxt = (lr.price / lr.area / 30).toFixed(0) + '元/m²•月';
			                           		}
			                           	}
