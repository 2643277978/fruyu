  ...
  function sendVerCode(a){
	...
	function getList(tr){
		 ...
		 if(action=="sale"){//二手房
            ...
            url =  masterDomain + "/include/ajax.php?service=house&action=saleList&check_collect=1&page=" + atpage + "&pageSize=" + pageSize + "&zj=" + zj;
            ...
            url =  masterDomain + "/include/ajax.php?service=house&action=zuList&check_collect=1&page=" + atpage + "&pageSize=" + pageSize + "&zj=" + zj;
            ...
            url =  masterDomain + "/include/ajax.php?service=house&action=xzlList&page=" + atpage + "&pageSize=" + pageSize + "&zj=" + zj;
            ...
            url =  masterDomain + "/include/ajax.php?service=house&action=spList&check_collect=1&page=" + atpage + "&pageSize=" + pageSize + "&zj=" + zj;
            ...
            url =  masterDomain + "/include/ajax.php?service=house&action=cfList&check_collect=1&page=" + atpage + "&pageSize=" + pageSize + "&zj=" + zj;
            ...
            url =  masterDomain + "/include/ajax.php?service=house&action=cwList&check_collect=1&page=" + atpage + "&pageSize=" + pageSize + "&zj=" + zj;
        }
							...
							if(action=="sale"){//二手房
								html.push('<li class="fn-clear">');
									...
									html.push('<div class="infobox fn-left">');
                            			...
                            			html.push('<div class="lpinf fn-clear"><div class="sp_l fn-left"><span>'+list[i].room+'</span><em>|</em><span>'+parseInt(list[i].area).toFixed(1)+'m²</span><em>|</em><span>'+list[i].buildage+'年</span><em>|</em><span>'+list[i].direction+'</span><em>|</em><span>'+list[i].zhuangxiu+'</span><em>|</em><span>'+list[i].bno+'/'+list[i].floor+'层</span><em>|</em><span>'+elevatortxt+'</span></div><div class="sp_r fn-right">'+parseInt(list[i].unitprice).toFixed(0)+' 元/m²</div></div>');

										html.push('<p class="lpinf">['+list[i].addr[3]+']  '+list[i].address+'</p>');
								...
								html.push('<li class="fn-clear">');
									...
									html.push('<div class="infobox fn-left">');
			                            ...
			                            html.push('<a href="'+list[i].url+'"><h2>'+list[i].title+'</h2></a>');
			                            if(list[i].price>0){
			                                html.push('<span class="lpprice"><b>'+parseInt(list[i].price).toFixed(0)+'</b>元/月</span>');
			                            }else{
			                                html.push('<span class="lpprice"><b>面议</b></span>');
			                            }
			                            html.push('</div>');
								...
								html.push('<li class="fn-clear">');
									...
									html.push('<div class="infobox fn-left">');
			                            ...
			                            if(list[i].price>0){
			                            	if(list[i].type==0){
												html.push('<span class="lpprice"><b>'+parseInt(list[i].price).toFixed(0)+'</b>元/m²•月</span>');
			                            	}else{
			                            ...
			                            if(list[i].price>0){
											if(list[i].type==1){
												elevatortxt = (list[i].price / list[i].area * 10000).toFixed(0) + '元/m²';
			                            	}else{
			                            		elevatortxt = (list[i].price * list[i].area).toFixed(0) + '元/月';
			                            	}
			                            }else{
											elevatortxt = '面议';
			                            }
