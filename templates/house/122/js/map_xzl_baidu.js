$(function(){
					...
					"success": function(data){
						...
						if(data && data.state == 100){
							...
							for(var i = 0; i < _list.length; i++){
								...
								if(_list[i].type==1){
									saleDate[i]['type'] ="出售";
									saleDate[i]['price_total'] = _list[i].price+'万元';
								}else {
									saleDate[i]['type'] ="出租";
									saleDate[i]['price_total'] = _list[i].price+'元/m²·月';
								}
	...
	var bubbleMapSize = {
		...
		,bubbleTemplate = {
			...
			//楼盘价格
			moreTpl: '<p class="num"><span class="house-type"></span>均价${priceTpl}<span class="gt">&gt;</span></p>',
