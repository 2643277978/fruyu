$(function(){
    ...
    $(".PackageList").delegate(".PackageBox_ADD","click",function(){
        ...
        if(id==1){
            box.append('<div class="PackageBox_de"><div class="PackageBox_littledel"></div><div class="PL_Name fn-clear"><em>类型</em><input type="text"class="tit"value=""></div><div class="PL_number"><em>说明</em><input class="desc"type="text"value=""><em>费用</em><input class="pric"type="text"value=""></div></div>');
        }else if(id==2){
            box.append('<div class="PackageBox_de"><div class="PackageBox_littledel"></div><div class="PL_Name fn-clear"><em>服务类型</em><input type="text"class="tit"value=""></div><div class="PL_number"><em>价格</em><input class="desc"type="text"value=""><em>备注</em><input class="pric"type="text"value=""></div></div>');
        }else if(id==3){
            box.append('<div class="PackageBox_de"><div class="PackageBox_littledel"></div><div class="PL_Name fn-clear"><em>费用</em><input type="text"class="tit"value=""></div><div class="PL_number"><em>完全自理</em><input class="price1"type="text"value=""><em>轻度失能</em><input class="price2"type="text"value=""></div><div class="PL_number"><em>中度失能</em><input class="price3"type="text"value=""><em>重度失能</em><input class="price4"type="text"value=""></div><div class="PL_number"><em>失智长者</em><input class="price5"type="text"value=""></div></div>');
        }
