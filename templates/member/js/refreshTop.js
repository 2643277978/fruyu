		...
		update_zjuser_btn: function(type, need){
			...
			if(rtConfig.zjuserMeal.meal_check.state == 200){
				...
				if(type == 'refresh'){
					...
					jinbi="个";
					info = langData['siteConfig'][30][68]+name+langData['siteConfig'][30][69]+'<font color="#ff6600">'+has+'</font>'+jinbi+'<br>'+langData['siteConfig'][30][70]+'<font style="color:#f60;">'+Math.round(need)+'</font>'+jinbi;
					//您是经纪人，已购买套餐<br>剩余---次数共-----次---当前操作需要消耗----次
				}
